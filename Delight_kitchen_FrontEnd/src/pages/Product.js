...
const addData=()=>
{
  ...
  if(name.length==0||price.length==0||categoryId.length==0 || price<1)
  {
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-body">
       ...
       <input   onChange={(e)=>{setPrice(e.target.value)}} className="form-control" type="number" min={1} />
       </form>
      </div>
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-body">
       ...
       <label style={{marginRight:"5px",marginTop:"5px"}} className="fs-5">Price: </label>
       <input value={price}  onChange={(e)=>{setPrice(e.target.value)}} className="form-control" type="number" min={1}/>
