...
const addData=()=>
{
    ...
    if(name.length==0 || capacity.length==0 || capacity<2 )
    {
  ...
  <div className="modal-dialog">
    <div className="modal-content">
      ...
      <div className="modal-body">
       ...
       <input   onChange={(e)=>{if(e.target.value>0) setCapacity(e.target.value)}}  className="form-control" type="number" min={1}/>
    ...
    <div className="modal-content">
      ...
      <div className="modal-body">
       ...
       <input  value={capacity}  onChange={((e)=>{
        if(e.target.value>0)
        setCapacity(e.target.value)})} type="number" min={1}  className="form-control" />
