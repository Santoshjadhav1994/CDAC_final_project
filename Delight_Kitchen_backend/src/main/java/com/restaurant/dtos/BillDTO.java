...
public class BillDTO {
	...
	public String toString() {
		return "BillDTO [billOrderId=" + billOrderId + ", billCashierId=" + billCashierId + ", taxAndCharge="
				+ taxAndCharge + ", discount=" + discount + ", billAmount=" + billAmount + ", billTotal=" + billTotal
				+ ", billDate=" + billDate + ", billPaymentMethod=" + billPaymentMethod + ", billStatus=" + billStatus
				+ "]";
	}
