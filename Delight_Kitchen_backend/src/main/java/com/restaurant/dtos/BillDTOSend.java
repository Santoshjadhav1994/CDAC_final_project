...
public class BillDTOSend {
	...
	public String toString() {
		return "BillDTOSend [billId=" + billId + ", billOrderId=" + billOrderId + ", billCashierName=" + billCashierName
				+ ", waiterName=" + waiterName + ", taxAndCharge=" + taxAndCharge + ", discount=" + discount
				+ ", billAmount=" + billAmount + ", billTotal=" + billTotal + ", billDate=" + billDate
				+ ", billPaymentMethod=" + billPaymentMethod + ", billStatus=" + billStatus + ", tableName=" + tableName
				+ ", tableId=" + tableId + "]";
	}
