...
public class Bill {
	...
	public String toString() {
		return "Bill [billId=" + billId + ", taxAndCharge=" + taxAndCharge + ", discount=" + discount + ", billAmount="
				+ billAmount + ", billTotal=" + billTotal + ", billDate=" + billDate + ", billPaymentMethod="
				+ billPaymentMethod + ", billStatus=" + billStatus + ", billOrder=" + billOrder + ", billCashier="
				+ billCashier + "]";
	}
